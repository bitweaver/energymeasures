	...
	{jstabs}
			...
			{form}
				{legend legend="Display Values"}
					...
					<div class="control-group submit">
						<input type="submit" class="btn btn-default" name="game_settings" value="{tr}Save Settings{/tr}" />
					</div>
				{/legend}
			{/form}
		{/jstab}
		...
		{jstab title="EnergyMeasures Settings"}
			{form}
				{legend legend="Javascript Cache"}
					<input type="hidden" name="page" value="{$page}" />
					<input type="submit" class="btn btn-default" name="energymeasures_refresh_js" value="{tr}Refresh Cached Javascript{/tr}" />
		...
		{jstab title="List Settings"}
			{form}
				...
				{/legend}
				<div class="control-group submit">
					<input type="submit" class="btn btn-default" name="energymeasures_settings" value="{tr}Change preferences{/tr}" />
				</div>
			{/form}
		{/jstab}
